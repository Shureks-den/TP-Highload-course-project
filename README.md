...
Основые пользовательские сценарии:
    ...
    1. Авторизация;
    2. Прослушивание музыки (в среднем, 120 минут в день[4]);
    3. Добавление песен в плейлисты;
    4. Поиск групп, плейлистов, альбомов, песен;
    5. Прослушивание песни (ее стриминг и загрузка информации - обложка, текст и тд).
